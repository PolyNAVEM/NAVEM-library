...
def compute_strong_term(cell2_d_index: int,
                        ...
                        local_space_data: LocalSpace_PCC_2D.LocalSpaceData,
                        test: ITest,
...
def compute_weak_term(cell2_d_index: int,
    ...
    for ed in range(num_vertices):
        ...
        # compute vem values
        weak_reference_segment = gedim.quadrature.Quadrature_Gauss1D.fill_points_and_weights(2 * reference_element_data.method_order)
        ...
        weak_basis_function_values = local_space_data.basis_functions_values_on_edge(ed,
...
def assemble(geometry_utilities_confi: gedim.GeometryUtilitiesConfig,
    ...
    result = EllipticPCC2DProblemData()
    ...
    for c in range(mesh.cell2_d_total_number()):
        ...
        compute_strong_term(c, mesh, mesh_do_fs_info, do_fs_data, reference_element_data, local_space_data,
                            test, result)
        compute_weak_term(c, mesh, mesh_geometric_data, mesh_do_fs_info, do_fs_data, reference_element_data,
