...
def main():
    ...
    test_type = 1
    method_orders = [1]
    method_types = [1, 1, 2, 3]
    method_types_name = ["h_navem", "p_navem", "fem", "vem"]
    dictionary_files = ['./TrainedModels/H-NAVEM/dictionary.txt', './TrainedModels/P-NAVEM/dictionary.txt', '', '']
    mesh_types = [5, 0]
